...
class BluetoothConnectionHelper {
    ...
    companion object {
        ...
        const val MEDIA_TYPE_AUDIO = 4
         ...
         /**
         * MEDIA_TYPE_CSV: a constant representing CSV file types
         */
        const val MEDIA_TYPE_CSV = 5
        ...
        fun getPublicStorageDir(fileName: String): File {
            ...
            when (mediaType) {
                ...
                MEDIA_TYPE_CSV -> directoryType = Environment.DIRECTORY_DOWNLOADS
        ...
        private fun getFileType(fileName: String): Int {
            ...
            when (extension) {
                ...
                "txt" -> return MEDIA_TYPE_PDF
                "csv" -> return MEDIA_TYPE_CSV
